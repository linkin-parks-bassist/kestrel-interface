...
KEST_TEST(test_ptr_dict_init_basic)
{
    dummy_ptr_dict dict;
...
KEST_TEST(test_ptr_dict_insert_duplicate)
{
    dummy_ptr_dict dict;
    dummy a = { .v = 1 };
    dummy b = { .v = 2 };
...
KEST_TEST(test_ptr_dict_insert_null_dict)
{
    dummy x = {0};
...
KEST_TEST(test_ptr_dict_insert_null_key)
{
    dummy_ptr_dict dict;
    dummy x = {0};
...
KEST_TEST(test_ptr_dict_insert_zero_buckets)
{
    dummy_ptr_dict dict;
    dummy x = {0};
...
KEST_TEST(test_ptr_dict_count_empty)
{
    dummy_ptr_dict dict;
    dummy_ptr_dict_init(&dict, 8);
...
KEST_TEST(test_ptr_dict_count_multiple)
{
    dummy_ptr_dict dict;
    dummy a = {1}, b = {2}, c = {3};
...
KEST_TEST(test_ptr_dict_index_basic)
{
    dummy_ptr_dict dict;
    dummy a = {1}, b = {2};
...
KEST_TEST(test_ptr_dict_index_out_of_bounds)
{
    dummy_ptr_dict dict;
    dummy a = {1};
...
KEST_TEST(test_ptr_dict_index_empty)
{
    dummy_ptr_dict dict;
    dummy_ptr_dict_init(&dict, 4);
...
KEST_TEST(test_ptr_dict_destroy_calls_destructor)
{
    dummy_ptr_dict dict;
    dummy a = {1}, b = {2};
...
KEST_TEST(test_ptr_dict_destroy_null_destructor)
{
    dummy_ptr_dict dict;
    dummy a = {1};
...
KEST_TEST(test_ptr_dict_destroy_empty)
{
    dummy_ptr_dict dict;
...
KEST_TEST(test_ptr_dict_index_matches_count)
{
    dummy_ptr_dict dict;
    dummy a = {1}, b = {2}, c = {3};
