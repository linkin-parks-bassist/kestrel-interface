...
KEST_TEST(kest_test_operand_const_zero)
{
    kest_block_operand op = operand_const_zero();
...
KEST_TEST(kest_test_operand_const_one)
{
    kest_block_operand op = operand_const_one();
...
KEST_TEST(kest_test_operand_const_minus_one)
{
    kest_block_operand op = operand_const_minus_one();
...
KEST_TEST(kest_test_init_block_null)
{
    int rc = kest_init_block(NULL);

    assert(rc == ERR_NULL_PTR);
}


KEST_TEST(kest_test_init_block_defaults)
{
    kest_block block;

    int rc = kest_init_block(&block);
...
KEST_TEST(kest_test_init_block_overwrites_existing_values)
{
    kest_block block;
