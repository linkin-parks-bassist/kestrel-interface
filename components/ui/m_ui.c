...
int enter_ui_page_backwardindirect_s(m_ui_page **_page)
{
	if (!_page)
		return ERR_NULL_PTR;
...
int ui_page_init_create_panel_label(m_ui_page *page)
{
	if (!page)
		return ERR_NULL_PTR;
...
m_button *ui_page_add_bottom_button(m_ui_page *page, const char *label, lv_event_cb_t cb)
{
	if (!page)
		return NULL;
