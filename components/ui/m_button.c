...
int create_button_ui(m_button *button, lv_obj_t *parent)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_create_label_ui(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int button_set_clicked_cb(m_button *button, lv_event_cb_t cb, void *cb_arg)
{
	if (!button)
		return ERR_NULL_PTR;
...
int button_set_pressing_cb(m_button *button, lv_event_cb_t cb, void *cb_arg)
{
	if (!button)
		return ERR_NULL_PTR;
...
int button_set_long_pressed_cb(m_button *button, lv_event_cb_t cb, void *cb_arg)
{
	if (!button)
		return ERR_NULL_PTR;
...
int button_set_released_cb(m_button *button, lv_event_cb_t cb, void *cb_arg)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_set_label(m_button *button, const char *label)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_disable_alignment(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_set_alignment(m_button *button, lv_align_t align, int offs_x, int offs_y)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_set_size(m_button *button, int width, int height)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_add_sub_button(m_button *button, m_button *sub_button)
{
...
int m_button_set_clickable(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_set_unclickable(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_enable(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_reset_state(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
...
int m_button_delete_ui(m_button *button)
{
	if (!button)
		return ERR_NULL_PTR;
