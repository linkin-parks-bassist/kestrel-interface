...
#define KEST_PRINTF_FORCE(...) do {kest_printf("%s:%03d: ", FNAME, __LINE__);kest_printf(__VA_ARGS__);} while (0);
#define KEST_PRINTF_FORCE_(...) do {kest_printf(__VA_ARGS__);} while (0);
