#ifndef KEST_INT_EFFECT_H_
#define KEST_INT_EFFECT_H_

#define EFFECT_MODE_FULL_SPECTRUM  0
#define EFFECT_MODE_UPPER_SPECTRUM	1
#define EFFECT_MODE_LOWER_SPECTRUM	2
#define EFFECT_MODE_BAND			3

#define EFFECT_WET_MIX_PID	0xFFFF

#define EFFECT_BAND_LP_CUTOFF_PID 	0xFFFE
#define EFFECT_BAND_HP_CUTOFF_PID 	0xFFFD
#define EFFECT_BAND_MODE_SID 		0xFFFF
