...
static const char *FNAME = "m_effect_init.c";
int init_3_band_eq(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_amplifier(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_band_pass_filter(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_compressor(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_delay(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_dirty_octave(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_distortion(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_envelope(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_flanger(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_high_pass_filter(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_low_end_compressor(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_low_pass_filter(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_noise_suppressor(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_percussifier(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_warbler(m_effect *effect)
{
	if (!effect)
		return ERR_NULL_PTR;
...
int init_effect_of_type(m_effect *effect, uint16_t type)
{
	if (!effect)
		return ERR_NULL_PTR;
